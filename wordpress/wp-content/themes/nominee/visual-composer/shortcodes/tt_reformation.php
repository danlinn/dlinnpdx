					...
					?>
						<div class="tt-item reformation-padding col-lg-<?php echo esc_attr($tt_atts['grid_column'] .' '. $tt_atts['grid_padding']);?> col-md-4 col-sm-6 col-xs-12" data-groups='[<?php echo implode( ',', $term ); ?>]'>
							...
							<figure class="tt-effect">
								...
								?>
							    <figcaption>
							      	<div class="content <?php echo esc_attr($tt_atts['content_visibility'] == 'visible' ? 'has-content' : ''); ?>">
							      		<?php if ($tt_atts['popup_visibility'] == 'visible' || $tt_atts['link_visibility'] == 'visible'): ?>
								            <div class="links">
								            	<?php if ($tt_atts['popup_visibility'] == 'visible') :
									            ...
									            if ($tt_atts['link_visibility'] == 'visible') : ?>
