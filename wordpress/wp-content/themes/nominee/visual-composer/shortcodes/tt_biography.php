...
<div class="party-leader-wrapper <?php echo esc_attr($tt_atts['el_class'].' '.$tt_custom_css); ?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-7 col-sm-6">
                <div class="biography-info-wrapper">
                    ...
                    $image_src = wp_get_attachment_image_src($tt_atts['leader_sign'], 'medium' ); ?>
    ...
    <?php if (!empty($education_info_data) || !empty($career_info_data)): ?>
        
        <div class="experience-info">
            
            <?php if (!empty($education_info_data) && $tt_atts['education_label']): ?>
            ...
            <?php if (!empty($career_info_data) && $tt_atts['career_label']): ?>
