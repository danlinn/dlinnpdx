...
<div class="tt-paypal-donation <?php echo esc_attr($tt_atts['el_class'].' '.$css_class); ?>">
    ...
    <form class="paypal-donate-form clearfix" action="https://www.paypal.com/cgi-bin/webscr" method="post">
        <?php do_action('nominee_before_donation_form'); ?>
        ...
        <div class="col-md-12">
            <div class="donate-amount btn-group" data-toggle="buttons">
                ...
                <input class="others-amount form-control" type="number" value="<?php echo esc_attr(nominee_option('donate-amount', false, false));?>" name="<?php echo esc_attr($amount_field);?>" placeholder="<?php esc_attr_e('or, enter your amount', 'nominee');?>">
            </div>
        </div>
        ...
        <?php do_action('nominee_after_donation_form'); ?>
