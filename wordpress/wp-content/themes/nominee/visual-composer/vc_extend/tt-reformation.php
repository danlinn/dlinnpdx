...
if (function_exists('vc_map')) :
    ...
    vc_map( array(
        ...
        'params'      => array(
            ...
            array(
                'type'        => 'dropdown',
                'heading'     => esc_html__( 'Image Popup Visibility ', 'nominee' ),
                'param_name'  => 'popup_visibility',
                'value'       => array(
                    esc_html__('Visible', 'nominee') => 'visible',
                    esc_html__('Hidden', 'nominee')  =>'hidden' ,
                ),
                'std' => 'visible',
                'description' => esc_html__( 'If you do not like to show popup then select hidden', 'nominee' ),
                'group' => esc_html__( 'Visibility', 'nominee' ),
            ),

            array(
                'type'        => 'dropdown',
                'heading'     => esc_html__( 'Link Popup Visibility ', 'nominee' ),
                ...
                'std' => 'visible',
                'description' => esc_html__( 'If you do not like to show link then select hidden', 'nominee' ),
                'group' => esc_html__( 'Visibility', 'nominee' ),
            ),
            array(
                'type'        => 'dropdown',
                'heading'     => esc_html__( 'Content Popup Visibility ', 'nominee' ),
                ...
                'std' => 'visible',
                'description' => esc_html__( 'If you do not like to show content then select hidden', 'nominee' ),
                'group' => esc_html__( 'Visibility', 'nominee' ),
            ),
