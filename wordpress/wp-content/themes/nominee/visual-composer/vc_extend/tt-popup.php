...
if (function_exists('vc_map')) :
    ...
    vc_map( array(
        ...
        'params'      => array(
            array(
                'type'        => 'dropdown',
                'heading'     => esc_html__( 'Styles', 'nominee' ),
                'param_name'  => 'styles',
                'value'       => array(
                    esc_html__('Style one', 'nominee') => 'style-one',
                    esc_html__('Style two', 'nominee')  => 'style-two'
                    ),
                'admin_label' => true,
                'description' => esc_html__( 'Select a style', 'nominee' )
            ),
