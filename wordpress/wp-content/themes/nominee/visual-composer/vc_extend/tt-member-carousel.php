...
if (function_exists('vc_map')) :
    ...
    // TT Member element
    vc_map( array(
        'name'                    => esc_html__( 'Members Carousel', 'nominee' ),
        'base'                    => 'tt_member_carousel',
        'icon'                    => 'fa fa-user',
        'category'                => esc_html__( 'TT Elements', 'nominee' ),
        'description'             => esc_html__( 'Show off member with carousel', 'nominee' ),
        'params'                  => array(
            array(
                'type'        => 'dropdown',
    ...
    if ( class_exists( 'WPBakeryShortCode' ) ) {
        class WPBakeryShortCode_TT_Member_Carousel extends WPBakeryShortCode {
        }
    }
