...
if ( ! function_exists( 'nominee_generate_css' ) ) {
     ...
     */
    function nominee_generate_css( $selector, $style, $value, $prefix = '', $suffix = '', $echo = true ) {
...
if ( ! function_exists( 'nominee_get_dynamic_css' ) ) {

    /**
     * Get CSS Built from Nominee Options.
     * Build CSS reflecting colors, fonts and other options set in the Nominee options, and return them for output.
     *
     * @since Nominee 3.6
     *
     */
    function nominee_get_dynamic_css() {
        // color options
