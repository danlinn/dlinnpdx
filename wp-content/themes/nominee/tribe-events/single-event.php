	...
	<div class="col-md-8 col-sm-8">
		<div id="tribe-events-content" class="tribe-events-single">
			...
			<div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
				<!-- Navigation -->
				<h3 class="tribe-events-visuallyhidden"><?php printf( esc_html__( '%s Navigation', 'nominee' ), $events_label_singular ); ?></h3>
			...
			<?php while ( have_posts() ) :  the_post(); ?>
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php echo tribe_event_featured_image( $event_id, 'nominee-blog-thumbnail', false ); ?>
					
					<div class="nominee-events-header">
			...
			<div id="tribe-events-footer">
				...
				<ul class="tribe-events-sub-nav">
					...
					<li class="tribe-events-back">
						<a href="<?php echo esc_url( tribe_get_events_link() ); ?>"> <?php printf(esc_html_x( 'All %s', '%s Events plural label', 'nominee' ), $events_label_plural ); ?></a>
					</li>
