        ...
        <div class="intro <?php echo esc_attr($tt_atts['content_alignment'])?>">
            <div class="container">
                ...
                <?php if ($tt_atts['title_part1']) : ?>
                    <span class="tt-title animated <?php echo esc_attr($tt_atts['title_part1_animation'] .' '. $tt_atts['title_part1_ani_delay'].' '.$tt_atts['title-sizes-lg'].' '.$tt_atts['title-sizes-md'].' '.$tt_atts['title-sizes-sm'].' '.$tt_atts['title-sizes-xs'] ); ?>" style="<?php echo esc_attr($title_font_size);?>"><?php echo esc_html($tt_atts['title_part1']);?></span>
                <?php endif; ?>

                <?php if ($tt_atts['title_part2']) : ?>
                    <span class="tt-title animated <?php echo esc_attr($tt_atts['title_part2_animation'] .' '. $tt_atts['title_part2_ani_delay'].' '.$tt_atts['title-sizes-lg'].' '.$tt_atts['title-sizes-md'].' '.$tt_atts['title-sizes-sm'].' '.$tt_atts['title-sizes-xs'] ); ?>" style="<?php echo esc_attr($title_font_size);?>"><?php echo esc_html($tt_atts['title_part2']);?></span>
                <?php endif; ?>
            </div>
        </div> <!-- .intro -->
    </li>
